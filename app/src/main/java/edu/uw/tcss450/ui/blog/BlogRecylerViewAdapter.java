...
public class BlogRecylerViewAdapter extends RecyclerView.Adapter<BlogRecylerViewAdapter.BlogViewHolder> {
    // Store the expanded state for each List item, true -> expand, false -> not
    private final Map<BlogPost, Boolean> mExpandedFlags;
    // Store all of the blogs to present
    private final List<BlogPost> mBlogs;

    public BlogRecylerViewAdapter(List<BlogPost> mBlogs) {
        this.mBlogs = mBlogs;
    ...
    /**
     * Objects from this class represent an Individual row View from the List of row in the Blog Recycler View
     */
    public class BlogViewHolder extends RecyclerView.ViewHolder {
        ...
        /**
         * When the button is clicked in the more state, expand the card to display the blog preview and
         * switch the icon to the less state. When the button is clicked in the less state, shrink the
         * card and switch the icon to the more state.
         *
        ...
        /**
         * Helper method to determine if the preview should be displayed or not.
         */
